...
**Předpokládaný průběh domácí přípravy - programování**

V ideálním světě by to mohlo vypadat takto:

*   Projdu si "teoretickou" přípravu, v našem případě ořezanou teorii v podobě **Jupyter souborů**. V těch je plno ukázek a cvičení pro pochopení základů. I když výčet není úplný a existuje milión dalších zdrojů a YouTube kanálů, stále trvám na tom, že než 4 hodiny teorie, tak raději 30 minut programování a hledání svých chyb. Teorii budeme postupně doplňovat, ale na začátku potřebuji spíš vaše nasazení v samotném programování.
    
*   Když něčemu nerozumím, zkusím na první dobrou hledat na netu. Pokud to nevede rychle k cíli, zkusím svou skupinu, jestli už to někdo neřešil a netuší... a když to neklapne, obrátím se na učitele (ten se rekurzivně obrátí na **net - skupina - na učitele**?). Samotná tvorba kódu programátorovi zabere tak 5 % celkového času, kdy "programuje". A to do toho nepočítám prokrastinaci.
    
*   Pokračuji dále na \*.py soubory. Zde by VŽDY měl být postup - **nejdříve EMPY soubory** se zadáním a nápovědou. Základem jsou jednohvězdičkové úkoly, o které se máte pokoušet nejprve sami (90 % času), potom s nápovědou z netu + AI, ale nesklouzávejte k rychlému ústupu a snadné cestě, bohužel se časem ukáže, že tohle bude spíše na škodu. Na to je vždy dost času i později, teď jde o zažití samotného programování, přemýšlení, hledání chyb ve vlastním kódu, vytrvání u kódování, když to zrovna nejde hladce. 
    
*   Následuje **dokumentace kódu**. Ne příliš oblíbená část, někdy přímo prudérní. Přesto na ni trvám a chci, ať ji děláte již od samotných začátků. Má to být zvyk, ne hrozba od šéfa. Dodržujte nastavené standardy. Nejčastější pocit programátora je, že ten kód je tak jasný a průzračný, že není co dokumentovat, komentovat. V tom se musí vyznat i debil. Schválně se zeptejte všech, co již programují ve větších firmách a v týmech. Ten pocit zná každý, většina už ale přišla i do styku s kódem, který nebyl popsaný (protože je to přeci jasné) a ve kterém se měli vyznat a zorientovat. Samozřejmě se vám to nakonec povede, ale mohlo to být daleko snazší, kdyby byl kód veden a popisován předem. Kromě docstrings rozhodně doporučuji následující - když přidáváte do kódu podmínky, protože něco nefungovalo, je velmi vhodné napsat základní info, proč tohle a tohle přidáváte. Co se tím ošetří a které případy to zachytí. Samozřejmě, když už to píšete, tak je to přeci průzračně jasné a netřeba to ještě komentovat. Uvidíte. Nepodlehněte klamu, kdy znáte svůj kód v okamžiku, kdy jej tvoříte.
    
*   Předposledním krokem by mělo být **čtení kódu v souboru \*.py s řešením**. Hned na začátku tvrdím, že rozhodně si nekladu za cíl vytvořit dokonalý kód. Dokonce věřím a doufám, že váš kód bude lepší a čitelnější. Snad nasáváte všechny impulsy jako houba a získáváte cvik, na který já už nemám dost času ani procvičování. V řešení se naučte číst, dívejte se, co je řešeno jinak, **rozšiřte svůj kód**, pokud uznáte, že něco z toho je šikovné, že něco jste opomněli, že něco je navíc. Kupodivu i tato část je velmi důležitá, protože budete propojovat svůj kód s někým dalším, provádí vlastně merge a učíte se hledat, proč to nefunguje vám, ale "jemu" jo.
    
*   **Úkoly s více hvězdičkami** jsou něco jako rozšíření, pokud budete mít chuť a sílu, hledejte řešení sami. Pokud ne, rozhodně stále pro vás platí prostudování kódu v řešení. Někde budou části kódu zakomentované, někde je třeba něco zkusit nebo změnit. Stále se učíte číst kód. Cizí kód. To bude tak 40 % vašeho "programování". Nevěšte hlavu, pokud narazíte na partie, které ještě nemáte "probrány", tak to normálně chodí. Mrkněte na zdroják poprvé, příště zase někde uvidíte podobný kód, časem to bude snazší a snazší, i když dané knihovny nebo obraty ještě neznáte. Netřeba luštit každý detail, něco se časem utřepe samo.
